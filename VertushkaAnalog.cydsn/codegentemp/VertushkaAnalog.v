// ======================================================================
// VertushkaAnalog.v generated from TopDesign.cysch
// 11/29/2020 at 15:36
...
module ADC_SAR_SEQ_P4_v2_40_1 (
	...
	cy_clock_v1_0
		#(.id("13e7c61f-f8ef-421c-b461-bb8ae71c9add/5c71752a-e182-47ca-942c-9cb20adbdf2f"),
		  .source_clock_id(""),
		  .divisor(0),
...
module top ;
	...
	wire [0:0] tmpOE__Pulse_net;
	wire [0:0] tmpFB_0__Pulse_net;
	wire [0:0] tmpIO_0__Pulse_net;
	wire [0:0] tmpINTERRUPT_0__Pulse_net;
	electrical [0:0] tmpSIOVREF__Pulse_net;
	...
	cy_psoc3_pins_v1_10
		...
		Pulse
		 (.oe(tmpOE__Pulse_net),
		  .y({Net_662}),
		  .fb({tmpFB_0__Pulse_net[0:0]}),
		  .io({tmpIO_0__Pulse_net[0:0]}),
		  .siovref(tmpSIOVREF__Pulse_net),
		  .interrupt({tmpINTERRUPT_0__Pulse_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pulse_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_clock_v1_0
		#(.id("56c3deee-ca51-44fd-ab27-178bc9012dc4"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1000000000"),
		  .is_direct(0),
	...
	cy_clock_v1_0
		#(.id("4cb92c1d-0bed-4981-b9d8-b214206c0b45"),
		  .source_clock_id(""),
		  .divisor(0),
    ...
    // -- DFF Start --
    reg  cydff_1;
    always @(posedge Net_223)
    begin
        cydff_1 <= Net_1268;
    end
    assign Net_1265 = cydff_1;
    // -- DFF End --


    assign Net_1268 = ~Net_1265;
    ...
    cy_annotation_universal_v1_0 U5V (
        .connect({
            Net_334
        })
    );
    defparam U5V.comp_name = "Power_v1_0";
    defparam U5V.port_names = "T1";
    defparam U5V.width = 1;

	wire [0:0] tmpOE__PinRPM_net;
	wire [0:0] tmpFB_0__PinRPM_net;
	wire [0:0] tmpIO_0__PinRPM_net;
	wire [0:0] tmpINTERRUPT_0__PinRPM_net;
	electrical [0:0] tmpSIOVREF__PinRPM_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_buffer_sel(2'b00))
		PinRPM
		 (.oe(tmpOE__PinRPM_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PinRPM_net[0:0]}),
		  .analog({Net_477}),
		  .io({tmpIO_0__PinRPM_net[0:0]}),
		  .siovref(tmpSIOVREF__PinRPM_net),
		  .interrupt({tmpINTERRUPT_0__PinRPM_net[0:0]}),
		  .annotation({Net_493}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__PinRPM_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


    assign Net_662 = Net_655 & Net_654;

    CyControlReg_v1_80 EnablePWM (
        .control_1(Net_765),
        .control_2(Net_766),
        .control_3(Net_767),
        .control_0(Net_654),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam EnablePWM.Bit0Mode = 0;
    defparam EnablePWM.Bit1Mode = 0;
    defparam EnablePWM.Bit2Mode = 0;
    defparam EnablePWM.Bit3Mode = 0;
    defparam EnablePWM.Bit4Mode = 0;
    defparam EnablePWM.Bit5Mode = 0;
    defparam EnablePWM.Bit6Mode = 0;
    defparam EnablePWM.Bit7Mode = 0;
    defparam EnablePWM.BitValue = 0;
    defparam EnablePWM.BusDisplay = 0;
    defparam EnablePWM.ExtrReset = 0;
    defparam EnablePWM.NumOutputs = 1;

	wire [0:0] tmpOE__Pin_LED_G_net;
	wire [0:0] tmpFB_0__Pin_LED_G_net;
	wire [0:0] tmpIO_0__Pin_LED_G_net;
	wire [0:0] tmpINTERRUPT_0__Pin_LED_G_net;
	electrical [0:0] tmpSIOVREF__Pin_LED_G_net;

	cy_psoc3_pins_v1_10
		#(.id("53a979b0-b0b1-4925-920b-38e8bd8c9b98"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_LED_G
		 (.oe(tmpOE__Pin_LED_G_net),
		  .y({Net_945}),
		  .fb({tmpFB_0__Pin_LED_G_net[0:0]}),
		  .io({tmpIO_0__Pin_LED_G_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_LED_G_net),
		  .interrupt({tmpINTERRUPT_0__Pin_LED_G_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_LED_G_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("2cf5c68a-4c73-43f0-8a44-5b427e803c84"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
    ...
    CyControlReg_v1_80 LED_G (
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam LED_G.Bit0Mode = 0;
    defparam LED_G.Bit1Mode = 0;
    defparam LED_G.Bit2Mode = 0;
    defparam LED_G.Bit3Mode = 0;
    defparam LED_G.Bit4Mode = 0;
    defparam LED_G.Bit5Mode = 0;
    defparam LED_G.Bit6Mode = 0;
    defparam LED_G.Bit7Mode = 0;
    defparam LED_G.BitValue = 0;
    defparam LED_G.BusDisplay = 0;
    defparam LED_G.ExtrReset = 0;
    defparam LED_G.NumOutputs = 1;

    CyControlReg_v1_80 LED_R (
        .control_1(Net_1007),
        .control_2(Net_1008),
        .control_3(Net_1009),
        .control_0(Net_951),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam LED_R.Bit0Mode = 0;
    defparam LED_R.Bit1Mode = 0;
    defparam LED_R.Bit2Mode = 0;
    defparam LED_R.Bit3Mode = 0;
    defparam LED_R.Bit4Mode = 0;
    defparam LED_R.Bit5Mode = 0;
    defparam LED_R.Bit6Mode = 0;
    defparam LED_R.Bit7Mode = 0;
    defparam LED_R.BitValue = 0;
    defparam LED_R.BusDisplay = 0;
    defparam LED_R.ExtrReset = 0;
    defparam LED_R.NumOutputs = 1;
